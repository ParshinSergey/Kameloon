...
VALUES ('1st Article', 3, '2023-02-13', 1),
       ('2nd Article', 5, '2016-02-14', 2),
       ('3rd Article', 2, '2016-02-15', 1),
       ('4th Article', 4, '2016-02-16', 4),
       ('5th Article', 2, '2016-02-16', 4),
       ('6th Article', 5, '2016-02-17', 2),
       ...
       ('12 Article', 1, '2016-02-20', 2),
       ('13 Article', 0, '2016-02-21', 6),
       ('14 Article', 0, '2016-02-21', 1),
       ('15 Article', 0, '2016-02-21', 1),
       ('16 Article', 0, '2016-02-22', 1);
...
VALUES (TRUE, 1, '2023-02-14', 1),
       ...
       (TRUE, 2, '2023-02-14', 5),
       (TRUE, 2, '2023-02-14', 6),
       (FALSE, 1, '2023-02-14', 2),
       (TRUE, 1, '2023-02-14', 3),
       (TRUE, 1, '2023-02-14', 4),
       (TRUE, 1, '2023-02-15', 5),
       (TRUE, 3, '2023-02-14', 3),
       (FALSE, 3, '2023-02-14', 2),
       (TRUE, 3, '2023-02-14', 4),
       (TRUE, 3, '2023-02-15', 5);